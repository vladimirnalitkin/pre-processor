...
import com.van.processor.jdbc.parameter.SqlParameterType;
import com.van.processor.jdbc.parameter.SqlParameterValue;
import com.van.processor.jdbc.sql.DisposableSqlTypeValue;
import com.van.processor.jdbc.sql.SqlTypeValue;
import com.van.processor.jdbc.sql.SqlValue;
...
public abstract class StatementCreatorUtils {
	...
	public final static Logger log = LoggerFactory.getLogger(StatementCreatorUtils.class);
	...
	static boolean shouldIgnoreGetParameterType = true; //SpringProperties.getFlag(IGNORE_GETPARAMETERTYPE_PROPERTY_NAME);
	 ...
	 */
	public static void setParameterValue(PreparedStatement ps, int paramIndex, SqlParameterType param,
	 ...
	 * @see SqlTypeValue
	 */
	public static void setParameterValue(PreparedStatement ps, int paramIndex, int sqlType, String typeName, Integer scale,
										 Object inValue) throws SQLException {

		setParameterValueInternal(ps, paramIndex, sqlType, typeName, scale, inValue);
	}
	...
	private static void setParameterValueInternal(PreparedStatement ps, int paramIndex, int sqlType,
		...
		if (inValue instanceof SqlParameterValue) {
			...
			if (log.isDebugEnabled()) {
				log.debug("Overriding type info with runtime info from SqlParameterValue: column index " + paramIndex +
		...
		if (log.isTraceEnabled()) {
			log.trace("Setting SQL statement parameter value: column index " + paramIndex +
	...
	public static <T> Consumer<T> throwingWrapper(ThrowingLambdaException<T, Exception> throwingConsumer) {
		return param -> {
			try {
