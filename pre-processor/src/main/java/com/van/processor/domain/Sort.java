...
public class Sort implements Streamable<Sort.Order>, Serializable {
     ...
     */
    private Sort(Direction direction, String... properties) {
    ...
    /**
     * Creates a new {@link Sort} for the given string.
     *
     * @param sort can be null.
     * @return Sort
     */
    public static Sort by(String sort) {

        return Strings.isNullOrEmpty(sort) ? Sort.unsorted() : by(sort.split(","));
    }
